...
def dapetin_tetangga_acak(solusi: tuple) -> tuple:
    """
    Mendapatkan SATU keadaan tetangga acak dari solusi saat ini.
    """
...
def simulated_annealing(suhu_awal: float = 100.0, 
                        laju_pendinginan: float = 0.995, 
                        max_iterasi: int = 5000):
    """
